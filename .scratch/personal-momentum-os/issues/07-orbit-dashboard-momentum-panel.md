# 07: Orbit Dashboard & Portfolio Momentum Instrument Panel
...
**Blocked by:** 04: Priority Phase Transitions & State History, 05: Long-Form Synthesis Reflection Editor & Knowledge Capture, 06: Deterministic Trajectory & Pacing Engine

**Status:** ready-for-agent

- [ ] Section A (Orbit): Visual matrix organizing active priorities by current phase (`SPARK`, `FIRE`, `COOK`).
- [ ] Section B (Momentum): Aggregate event counts with configurable time window filters (7d, 30d, 90d, all-time).
...
- [ ] Section E (Signals): Deterministic, non-judgmental observational notices (e.g., Cook-without-synthesis count, pacing gaps).
